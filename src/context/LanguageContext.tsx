...
const dict = {
  EN: {
    ...
    store: "STORE",
    drop001: "DROP 001 — New Arrivals",
    drop000: "DROP 000 — Archive",
    arrowNew: "↓ New Arrivals",
    ...
    min: "MIN",
    sec: "SEC",
    markCalendar: "Mark your calendar. Set your alarm.",
    footerTagline: "brand born between casablanca and elsewhere. we were made to create.",
  ...
  FR: {
    ...
    storeTagline: "Ceci est la boutique. Voici l'inventaire — chaque marque, chaque choix, chaque silence, prêt à être porté.",
    store: "BOUTIQUE",
    drop001: "DROP 001 — Nouveautés",
    drop000: "DROP 000 — Archive",
    arrowNew: "↓ Nouveautés",
    arrowArchive: "↓ Archive",
    ...
    min: "MIN",
    sec: "SEC",
    markCalendar: "Notez la date. Réglez votre alarme.",
    footerTagline: "marque née entre casablanca et ailleurs. nous sommes faits pour créer.",
    storeEN: "This is the store.",
