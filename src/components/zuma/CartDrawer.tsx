    ...
    <>
      ...
      >
        <header className="flex justify-between items-center px-6 py-5 border-b border-border">
          <h2 className="font-display text-xl tracking-[0.3em]">CART</h2>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          {cart.length === 0 ? (
            <p className="text-xs tracking-[0.2em] uppercase text-muted-foreground text-center mt-12">Your cart is empty</p>
          ) : (
                ...
                <li key={item.id} className="flex gap-4 border-b border-border pb-5">
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="text-[10px] tracking-[0.2em] uppercase text-muted-foreground mt-1">{item.category}</div>
                    </div>
        ...
        <footer className="border-t border-border px-6 py-5 flex flex-col gap-4">
          <div className="flex justify-between text-sm">
            <span className="tracking-[0.22em] uppercase text-muted-foreground">Total</span>
