  ...
  return (
    <SiteLayout>
      ...
      <header id="hero" className="relative h-screen overflow-hidden flex flex-col justify-end px-6 md:px-10 pb-14 border-b border-border">
        <div className="absolute inset-0 bg-cover animate-hero-reveal" style={{ backgroundImage: `url(${heroImg})`, backgroundPosition: "center 15%" }}
      ...
      <Countdown targetIso="2026-06-01T00:00:00" headline="IPSEITY — INCOMING" />
      ...
      <section id="archive" className="px-6 md:px-10 py-20 border-b border-border reveal text-center">
        <div className="max-w-[1200px] mx-auto">
          ...
          <p className="text-[10px] tracking-[0.25em] uppercase text-muted-foreground">Coming soon</p>
        </div>
      </section>
    </SiteLayout>
  );
